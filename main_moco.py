...
parser.add_argument(
    "--moco-dim", default=256, type=int, help="feature dimension (default: 256)"
)
parser.add_argument(
    "--moco-mlp-dim",
    default=4096,
...
parser.add_argument(
    "--moco-t", default=1.0, type=float, help="softmax temperature (default: 1.0)"
)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        if args.multiprocessing_distributed:
            ...
            # args.rank: node rank -> global rank
    ...
    # 根据batch size调整学习率。BatchSize越大，训练越稳定，学习率适当增大
...
def adjust_moco_momentum(epoch, args):
    ...
    m = 1.0 - 0.5 * (1.0 + math.cos(math.pi * epoch / args.epochs)) * (
        1.0 - args.moco_m
    )
    return m
